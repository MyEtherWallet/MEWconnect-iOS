...
#import "InfoAssembly_Testable.h"
...
@interface InfoAssemblyTests : RamblerTyphoonAssemblyTests

@property (nonatomic, strong) InfoAssembly *assembly;

@end

@implementation InfoAssemblyTests
...
- (void)setUp {
    ...
    self.assembly = [[InfoAssembly alloc] init];
...
- (void)testThatAssemblyCreatesViewController {
    // given
    Class targetClass = [InfoViewController class];
    NSArray *protocols = @[
...
- (void)testThatAssemblyCreatesPresenter {
    // given
    Class targetClass = [InfoPresenter class];
    NSArray *protocols = @[
...
- (void)testThatAssemblyCreatesInteractor {
    // given
    Class targetClass = [InfoInteractor class];
    NSArray *protocols = @[
...
- (void)testThatAssemblyCreatesRouter {
    // given
    Class targetClass = [InfoRouter class];
    NSArray *protocols = @[
